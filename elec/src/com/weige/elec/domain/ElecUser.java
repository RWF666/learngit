...
public class ElecUser implements java.io.Serializable {
	...
	//非持久化属性
	private String message;     //数据库是否已存在用户名的标示
	private File[] uploads;		//上传的文件
	private String[] uploadsFileName;			//上传的文件名
	private String[] uploadsContentType;		//上传的文件类型
	private String fileID;  //文件id
	private InputStream inputStream;   //文件下载流的属性
	private String viewflag; // 查看用户是viewflag=1,编辑用户时viewflag=null
	private String password; //用来判断编辑的时候密码是否被修改
	private String roleflag; //用来判断管理员的层级，便于编辑界面的跳转
