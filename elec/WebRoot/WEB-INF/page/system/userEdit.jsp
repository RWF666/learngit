...
<html>
  <head>
   ...
   /**dom对象的操作*/
	...
	function check_null(){
	    ...
	    //if($("#postID option:nth-child(1)").is(":selected"))
 ...
 <body>
    ...
    <table cellSpacing="1" cellPadding="5" width="680" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
     ...
     <tr>
         ...
         <td class="ta_01" bgColor="#ffffff">
         	<s:textfield name="logonName" maxlength="25" id="logonName" size="20" readonly="true"/>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.sexList" name="sexID" id="sexID" style="width:155px" value="sexID"
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.jctUnitList" name="jctUnitID" id="jctUnitID" style="width:155px" value="jctUnitID"
					listKey="ddlCode" listValue="ddlName"
					>
			</s:select>
			<font color="#FF0000">*</font>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="logonPwd" id="logonPwd"  showPassword="true" type="password" maxlength="25"  size="20" />
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">确认密码：</td>
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="passwordconfirm" type="password" value="%{logonPwd}" showPassword="true" maxlength="25"  size="20"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="birthday" format="yyyy-MM-dd" var="birthday"/>
			<s:textfield name="birthday" value="%{#birthday}" id="birthday"  maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.isDutyList" name="isDuty" id="isDuty" style="width:155px" 
					listKey="ddlCode" listValue="ddlName"
					>
			</s:select>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="onDutyDate" format="yyyy-MM-dd" var="onDutyDate"/>
			<s:textfield name="onDutyDate" value="%{#onDutyDate}" id="onDutyDate"  maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
			<font color="#FF0000">*</font>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：</td>
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="offDutyDate" format="yyyy-MM-dd" var="offDutyDate"/>
			<s:textfield name="offDutyDate" value="%{#offDutyDate}" id="offDutyDate"  maxlength="50" size="20" onClick="WdatePicker()" onblur="checkIsDuty(this)"></s:textfield>
		</td>
	</tr>
	<TR>
		<TD class="ta_01" align="center" bgColor="#f5fafe">备注：</TD>
		<TD class="ta_01" bgColor="#ffffff" colSpan="3">
			<s:textarea name="remark"  style="WIDTH:95%"  rows="4" cols="52"></s:textarea>
		</TD>
	</TR>
