			    ...
			    <s:if test="#request.list!=null && #request.list.size()>0">
					<s:iterator value="#request.list">
						<tr>
							...
							<td class="ta_01" align="center" width="60%"><input id="<s:property value="ddlCode"/>"
								name="itemname" type="text" value="<s:property value="ddlName"/>" size="45" maxlength="25"></td>
							<td class="ta_01" align="center" width="20%"><a href="#"
								onclick="delTableRow('<s:property value="ddlCode"/>')"> <img
									src="${pageContext.request.contextPath }/images/delete.gif"
									width="16" height="16" border="0" style="CURSOR:hand"></a></td>
						</tr>
					</s:iterator>
				</s:if>
				<s:else>
 ...
 <TR height=10><td colspan=3></td></TR>
  <tr>
     <td align="center" colspan=3>
     	<s:set value="#request.session.globle_popedom" var="popedom" scope="request"/>
