          ...
          <td width="84%" colspan="4">      
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                   ...
                   <s:select list="#request.noExpFields" 
                  		 	size="15" name="colname1" multiple="true" style="width:200px" id="colname1" 
                   ...
                   <s:select list="#request.expFields" 
                   			size="15" name="" multiple="true" style="width:200px" id="colname2" 
                   			ondblclick="JavaScript:Add('colname2','colname1','colname')">
