...
<Script language="javascript">
 ...
 <br>
    ...
    <tr>
     ...
     <tr>
         ...
         <td class="ta_01" bgColor="#ffffff">
         	<s:textfield name="logonName" type="text" maxlength="25" id="logonName" size="20" onblur="checkUser(this);"/>
         	<div id="check"></div>
         </td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.sexList" name="sexID" id="sexID" style="width:155px" 
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.jctList" name="jctID" id="jctID" style="width:155px" 
					listKey="ddlCode" listValue="ddlName"
					headerKey="" headerValue="请选择" onclick="findJctUnit(this)"
					>
			</s:select>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			<%-- <s:select list="#request.postList" id="jctUnitID" name="jctUnitID" style="width:155px" 
					listKey="ddlCode" listValue="ddlName"
					headerKey="" headerValue="请选择"
					>
			</s:select> --%>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="logonPwd" id="logonPwd" type="password" maxlength="25"  size="20"/>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">确认密码：</td>
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="passwordconfirm" type="password" maxlength="25"  size="20"/>
		</td>
	</tr>
