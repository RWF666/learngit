	...
	<HEAD>
       ...
       function selectRole(){
          /* if(document.Form1.roleID.value=="0"){
            ...
            Pub.submitActionWithForm('Form2',${pageContext.request.contextPath }/system/elecRoleAction_home.do",'Form1');
          } */
          /**jquery对象*/
				...
				<TBODY>
					...
					<tr>
						...
						<td class="ta_01" align="left"  width="65%" >
							<s:select list="#request.roleList" name="roleID" id="Form1_roleID" class="bg" style="width:180px" onchange="selectRole()"
