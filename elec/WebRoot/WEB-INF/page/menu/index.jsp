						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								...
								<tr>
									...
									<td><input type="text" name="name" style="width: 125 px" size="20" value="<s:property value="#request.name"/>"  maxlength="25"></td>
	
								</tr>
								<tr>
									<td width="100"><img border="0" src="${pageContext.request.contextPath}/images/mima.jpg" width="75" height="20"></td>
									<td><input type="password" name="password" style="width: 125 px" size="20" value="<s:property value="#request.password"/>"  maxlength="25"></td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" name="remeberMe" id="remeberMe" value="yes" <s:property value="#request.checked"/>/>
									</td>
								</tr>
