...
<body onload="init();">
	...
	<form id="Form1" name="Form1"
		...
		<table id="opperate1" cellSpacing="0" cellPadding="0" width="700" align="center"
			...
			<TBODY>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01"><s:select list="#request.jctList"
										name="projId" id="projId" style="width:160px"
										listKey="ddlCode" listValue="ddlName" headerKey=""
										headerValue="全部" onchange="changeList();">
									</s:select></td>
								<td width="100" class="ta_01" align="center" bgcolor="#f5fafe"
									height="22">图纸类别：</td>
								<td class="ta_01"><font face="宋体" color="red"> <s:select
											list="#request.picList" name="belongTo" id="belongTo"
											style="width:160px" listKey="ddlCode" listValue="ddlName"
											headerKey="" headerValue="全部" onchange="changeList();">
										</s:select>
								</font></td>
							</tr>
						</table>
				...
				<tr>
					...
					<TD width="80%" align="right"><input type="button"
						...
						style="font-size:12px; color:black; height=20"> <input
						type="button" name="BT_Submit" value="上传" id="BT_Submit"
						onclick="addFileList();"
						style="font-size:12px; color:black; height=20"> <input
						type="button" value="关闭" onClick="window.close();"
						style="font-size:12px; color:black; height=20"></TD>
				</tr>
		...
		<!--文件上传添加进度条 begin-->
		<table id="load" width="700" border="0" align="center"
			bgcolor="#FAFAFA" cellpadding="0" cellspacing="0"
			bordercolor="#000000" style="border-collapse:collapse;display:none ">
			<tr>
				<td><br>
				<br>
					<table width="100%" border="1" cellspacing="0" cellpadding="0"
						bordercolor="#287BCE" style="border-collapse:collapse ">
						<tr bgcolor="#F7F7F6">
							<td width="20%" height="100" valign="middle">
								<table align='center' width='500'>
									<tr>
										<td colspan='2' align='center' id="progressPersent"><font
											size="2"> 正在进行保存，用时较长，请稍后... </font></td>
									</tr>
									<tr>
	...
	<form id="Form2" name="Form2"
		...
		<table id="opperate2" cellspacing="0" cellpadding="1" rules="all" bordercolor="gray"
