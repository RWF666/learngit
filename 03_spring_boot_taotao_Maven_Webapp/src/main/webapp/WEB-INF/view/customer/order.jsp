...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/purchase.checkout.css" />
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/taotao.js" charset="utf-8"></script>
</head>
<body id="mainframe">
<!--shortcut start-->
...
<!--shortcut end-->
	...
	<div class="w w1 header clearfix">
		<div id="logo"><a href="http://www.taotao.com/"><img src="${pageContext.request.contextPath}/resources/images/taotao-logo.gif"  alt="淘淘商城" /></a></div>
						  ...
						  <div class="p-img"><a href="http://www.taotao.com/item/${item.id}.html" target='_blank'><img width="52" height="52" src="${item.images[0]}"></a></div>
							 <div class="p-detail">
								...
								<span id="promise_1057746" class="promise411"></span>
					  				  ...
					  				  <td class="p-price"><strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${item.price / 1000 }"/></strong>
					  </td>
					  				  <td class="p-promotion"> </td>
...
<div class="bt bt-w freight-tooltip hide" id="transport">
   ...
   <div class="w">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/base-2011.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/lib-v1.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jTips.js"></script>
