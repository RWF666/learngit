...
<head>
    ...
    <title>注册-个人用户</title>
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/regist.personal.css"/>
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/passport.base.css"/>
...
<div class="w" id="logo">
    <div>
    	<a href="http://www.taotao.com/">
    		<img src="${pageContext.request.contextPath}/resources/images/taotao-logo.gif" alt="京东商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://weige.taotao.com/rest/customer/user/toLogin"
    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            ...
            <div class="phone">
                <img width="180" height="180" src="${pageContext.request.contextPath}/resources/images/phone-bg.jpg">
            </div>
                        <span class="clr"></span>
        </form>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/register/jd.lib.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/register/jdThickBox.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/register/jdValidate.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/register/jdValidate.emReg.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/register/jdValidate.regSuccess.js"></script>
