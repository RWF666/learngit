...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="${pageContext.request.contextPath}/resources/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://weige.taotao.com/rest/customer/index"><img clstag="clickcart|keycount|xincart|logo" src="${pageContext.request.contextPath}/resources/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页"></a></div>
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://weige.taotao.com/rest/customer/item/${cart.itemId }" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}" alt="${cart.itemTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://weige.taotao.com/rest/customer/item/${cart.itemId }" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.itemTitle}</a>
		            ...
		            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1" clstag="clickcart|keycount|xincart|btndel318558" class="cart-remove" href="/rest/customer/cart/delete/${cart.itemId}">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://weige.taotao.com/rest/customer/index" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://weige.taotao.com/rest/customer/order/toOrderCart" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
