...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/login/g.base.js"></script>
   	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
    	<a href="http://www.taotao.com/" clstag="passport|keycount|login|01">
    		<img src="${pageContext.request.contextPath}/resources/images/taotao-logo.gif" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(${pageContext.request.contextPath}/resources/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;">
			</div>
            <div class="form ">
        ...
        <div class="free-regist">
            <span><a href="http://weige.taotao.com/rest/customer/user/register" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/login/checkClient.js"></script>
<script>
