...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/myjd.common.css" media="all" />
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/myjd.order.css" media="all" />
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery-1.2.6.min.js"></script>
</head>
<body>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/base-2011.js" charset="utf-8"></script>
<!-- header start -->
...
<script type="text/javascript" language="javascript">
	...
	<c:forEach items="${orderList}" var="order">
        ...
        <tr id="track2538292730" oty="0,1,70" class="tr-td">
            ...
            <td><div class="u-name">${order.buyerNick }</div></td>
        	<td>
        		${order.payment }<br>
        		货到付款<br>
        	            	</td>
            <td>
                <span class="ftx-03">${order.createTime }</span>
            ...
            <a class="btn-again" clstag="click|keycount|orderlist|buy" href="http://cart.jd.com/cart/dynamic/reBuyForOrderCenter.action?wids=1113410,1222567&amp;nums=1,1&amp;rid=1419846299535" target="_blank">还要买</a>
	...
	</c:forEach>				    						            					    								    												<tbody id="tb-3965995220">
                ...
                <span class="prev" onclick="prePage('${page-1}','${totalPage}')">上一页<b></b></span>
       
		<!-- <span class="prev-disabled">首页</span> -->
               <a class="current">${page}</a>                                                                                       	<!-- <span class="next-disabled">末页</span>  -->
    <span class="next" onclick="nextPage('${page+1}','${totalPage}')">下一页<b></b></span>
...
<script type="text/javascript">
	function prePage(page,totalPage) {
		if(page<1){
			page=1;
		}
    window.location = "http://weige.taotao.com/rest/customer/order/myOrders?page="+page;
	};
