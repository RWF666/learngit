 ...
 */
function login() {
    return location.href = "http://weige.taotao.com/rest/customer/user/toLogin";
}
function regist() {
    return location.href = "http://weige.taotao.com/rest/customer/user/register";
}
...
function search(a) {
    var b = "http://weige.taotao.com/rest/customer/search?keyword=" + encodeURIComponent(document.getElementById(a).value);
