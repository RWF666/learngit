...
import com.weige.user.repository.EsBlogRepository;
...
public class EsBlogServiceImpl implements EsBlogService {
	...
	public Page<EsBlog> listHotestEsBlogs(String keyword, Pageable pageable) throws SearchParseException{
		...
		Sort sort = new Sort(Direction.DESC,"reading","comments","likes","createTime"); 
		if (pageable.getSort() == null) {
			pageable = new PageRequest(pageable.getPageNumber(), pageable.getPageSize(), sort);
		}
	...
	@Override
	public EsBlog deleteEsBlog(EsBlog esBlog) {
